...
import { ChevronLeft, ChevronRight, ArrowDownLeft, ArrowUpRight, Filter } from "lucide-react";
                  ...
                  <div className="space-y-1.5">
                    {txs.map((tx, i) => (
                      <motion.div
                        ...
                        className="neo-pressed flex items-center gap-3 p-2.5 cursor-pointer"
                      >
                        <div
